...
namespace WindowWorks.App.UI.Services
{
    ...
    public interface IHotkeyApplyService
    {
        ...
        HotkeyApplyResult ApplyHotkeys(string? commandPalette, string? emergencyReset, string? transparencyIncrease, string? transparencyDecrease, string? toggleTopmost, string? windowReparent = null, string? propertyInspector = null);
